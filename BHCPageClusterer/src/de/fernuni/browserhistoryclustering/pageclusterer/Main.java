...
public class Main {
   ...
   public static void main(String args[]) throws Exception {
      ...
      if (!s_Config.get_ReuseTFIDF()) {
         createTFIDF(v_HadoopConf, m_DocumentDir, m_SequenceDir, m_TokensDir, m_TF, m_VecFolder,
               m_tf_idf);
      }
   ...
   private static void createTFIDF(Configuration p_HadoopConf, Path p_DocumentDir,
         Path p_SequenceDir, Path p_TokensDir, Path p_TF, String p_VecFolder, Path p_tf_idf)
   ...
   private static void createSequence(String p_InputPath, String p_OutputPath) throws Exception {
   ...
   private static void createTokens(Path p_InputDir, Path p_OutputDir, Configuration p_Conf)
   ...
   private static void createTFIDFVectors(Path p_InputDir, Path p_OutputDir, Configuration p_Conf)
      ...
      TFIDFConverter.processTfIdf(p_InputDir, p_OutputDir, p_Conf, dfData, s_MinDf, s_MaxDFPercent,
            s_TFIDFNorm, true, s_SequentialAccessOutput, true, s_ReduceTasks);
