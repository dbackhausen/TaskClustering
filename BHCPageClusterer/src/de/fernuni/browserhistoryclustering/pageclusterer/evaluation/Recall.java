...
public class Recall {
   ...
   public double calculate(List<String> p_Files,
      ...
      Integer v_NumDocsOfClassInCluster = v_Class2OccCluster
            .get(v_DominantClass);
      Integer v_NumDocsOfClassInCollection = v_Class2OccCollection
            .get(v_DominantClass);

      return (double) v_NumDocsOfClassInCollection
            / (double) v_NumDocsOfClassInCluster;
   }

   private Map<String, Integer> getClassOccurrences(List<String> p_Filenames)
      ...
      for (String v_Class : v_Classes) {
         int v_Occurrences = Collections.frequency(v_MappedClusterFiles,
               v_Class);
   ...
   private Set<String> getClasses(List<String> p_Filenames)
         throws EvaluationException {
